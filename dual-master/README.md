...
*NOTE*: This stack uses EFS in provisioned mode, which is a better setting for large repos (> 3GB) since
it provides a lower latency compared to the burst mode.
